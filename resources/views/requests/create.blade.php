...
<div class="form-group">
	...
	{!! Form::text('ris_number', '',['class' => 'form-control', 'placeholder' => 'Enter Your RIS Number Here']) !!}
</div>

<div class="form-group">
	{!! Form::label('requested_by_section', 'Requested By Section:')  !!}
	{!! Form::text('requested_by_section', '',['class' => 'form-control', 'placeholder' => 'Section Name']) !!}
</div>

<div class="form-group">
	{!! Form::label('requested_by_user', 'Requested By:')  !!}
	{!! Form::text('requested_by_user', '',['class' => 'form-control', 'placeholder' => 'What is your name?']) !!}
</div>

<div class="form-group">
	{!! Form::label('purpose', 'Purpose of Request:')  !!}
	{!! Form::textarea('purpose', '',['class' => 'form-control']) !!}
</div>
